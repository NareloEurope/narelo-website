...
- **Jessica Fletcher and Mercedes are team, not founders** (Vivien, 2026-09-05). The September audit listed them alongside Natalie and Vivien; that was wrong. **Jessica Fletcher** is Senior Educator and **Mercedes** is Brand Experience Manager. Neither is on the website yet, and when they are added it is as team, separate from the founders. Never present either of them as a founder.
  ⚠️ Still waiting on, so nothing about them can go on the site: Mercedes' surname, a photograph of each, and an introduction each. They are writing their own introductions, so do not draft one for them.
