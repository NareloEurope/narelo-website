...
export const es: Dict = {
  ...
  home: {
    ...
    belief: {
      eyebrow: 'Por qué Narelo',
      heading: 'Los niños necesitan algo más que conocimientos y actividades. Necesitan experiencias reales que dejen huella.',
      body: 'El conocimiento y la educación importan, pero los niños también necesitan experiencias reales donde practicar las capacidades que la vida les va a pedir.',
      pull: 'No podemos saber exactamente qué les pedirá el futuro a nuestros hijos. Pero sí podemos darles experiencias que les ayuden a prepararse para él.',
    ...
    parents: {
      eyebrow: 'Para los padres',
      heading: 'Tu tiempo también importa.',
      body: 'Con las experiencias semanales de Narelo, los padres ganan un tiempo propio y de confianza mientras sus hijos viven experiencias pensadas con intención.',
      body2: 'Y siempre que una familia necesite apoyo adicional, los sábados, durante las vacaciones escolares, en cumpleaños, eventos privados o a través de experiencias privadas individuales, Narelo puede encargarse también de la experiencia de los niños.',
      body3: 'Los padres pueden delegar con tranquilidad, sabiendo que su hijo está bien atendido por profesionales, genuinamente implicado y aprovechando su tiempo.',
      pull: 'Tiempo para ti. Experiencias que importan para ellos.',
      image: '/images/home-not-to-be-rushed.webp',
      imageAlt: 'Un grupo pequeño de niños explorando juntos, sin prisa.',
    },
    gain: {
      eyebrow: 'Qué se llevan los niños',
      heading: 'Las capacidades se practican.',
      body: 'A través de experiencias reales, los niños tienen la oportunidad de explorar, tomar decisiones, resolver problemas, colaborar, comunicarse, crear y descubrir de lo que son capaces.',
      body2: 'El desarrollo no llega de una sola actividad. Es la experiencia repetida la que les da ocasión de practicar esas capacidades con el tiempo.',
    },
    different: {
      eyebrow: 'Qué hace diferente a Narelo',
      heading: 'La diferencia no está en las actividades. Está en el pensamiento que hay detrás.',
      body: 'Lo que importa es la intención detrás de cada experiencia, cómo se relacionan las educadoras con los niños, cuánta guía se les da, cómo se enlazan unas experiencias con otras y la coherencia de nuestra filosofía.',
      notLabel: 'No nos preguntamos solo',
      notQuestion: '¿Qué actividad hacemos?',
      askLabel: 'Nos preguntamos',
      askQuestion: '¿Qué queremos que el niño viva?',
    },
    approach: {
      eyebrow: 'Nuestro enfoque',
      heading: 'Creemos en la experiencia real, en el vínculo humano y en una guía con sentido.',
      body: 'Los niños tienen la oportunidad de intentar, decidir, resolver, colaborar y enfrentarse a retos con el acompañamiento de educadoras de confianza.',
      pull: 'Acompañar, sin quitarles el camino.',
    },
    worlds: {
    ...
    ourBelief: {
      ...
      heading: 'Los niños necesitan algo más que actividades. Necesitan experiencias que importen.',
      body: 'Creemos que las capacidades se practican.',
      body2: 'Creemos que a los niños les hacen bien las experiencias reales, el vínculo humano, las oportunidades que se repiten y una guía con sentido.',
      body3: 'No podemos saber exactamente qué les pedirá el futuro.',
      body4: 'Pero sí podemos darles experiencias que les ayuden a prepararse para la vida.',
      pull: 'Los padres ganan tiempo. Los niños, experiencias que importan.',
    },
    closing: {
