...
export const es: Dict = {
  ...
  home: {
    ...
    belief: {
      ...
      heading: 'Algunas cosas se aprenden. Otras hay que vivirlas.',
      body: 'Nuestros hijos van a crecer en un mundo que no podemos prever del todo. Lo que sí podemos darles son oportunidades para pensar por sí mismos, moverse, crear, decidir, adaptarse y descubrir de lo que son capaces.',
      pull: 'Ahí es donde entra Narelo.',
    ...
    closing: {
      ...
      body: 'La membresía se abre a un número reducido de familias. Si sientes que Narelo es lo que tu familia estaba buscando, nos encantaría conoceros.',
      ctaLabel: 'Hablemos',
    },
  },
