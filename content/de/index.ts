...
export const de: Dict = {
  ...
  home: {
    hero: {
      ...
      lede: 'Narelo ist ein privater Members Club für Familien, rund um außergewöhnliche Kindheitserlebnisse.',
      lede2: 'Durch Natur, Kreativität, Bewegung und echte Abenteuer bekommen Kinder Gelegenheiten, zu erkunden, zu entscheiden, Probleme zu lösen, zusammenzuarbeiten, Beziehungen aufzubauen und zu entdecken, wozu sie fähig sind.',
      video: '/video/home-hero.mp4',
      poster: '/images/home-hero-poster.webp',
      scrollHint: 'Scrollen',
    },
    belief: {
      eyebrow: 'Warum Narelo',
      heading: 'Kinder brauchen mehr als Wissen und Programm. Sie brauchen echte Erlebnisse, die zählen.',
      body: 'Wissen und Bildung sind wichtig, und daneben brauchen Kinder echte Erlebnisse, in denen sie die Fähigkeiten üben können, auf die es im Leben ankommt.',
      pull: 'Wir können nicht wissen, was die Zukunft von unseren Kindern verlangen wird. Aber wir können ihnen Erlebnisse mitgeben, die sie darauf vorbereiten.',
    ...
    parents: {
      eyebrow: 'Für Eltern',
      heading: 'Ihre Zeit zählt auch.',
      body: 'Mit den wöchentlichen Erlebnissen von Narelo gewinnen Eltern verlässliche Zeit für sich, während ihre Kinder an Erlebnissen teilnehmen, die mit Absicht gestaltet sind.',
      body2: 'Und wann immer Familien darüber hinaus Unterstützung brauchen, samstags, in den Schulferien, an Geburtstagen, bei privaten Anlässen oder über einzelne private Erlebnisse, kann Narelo das Erlebnis der Kinder auch dort übernehmen.',
      body3: 'Eltern können die Verantwortung abgeben und wissen dabei, dass ihr Kind professionell betreut ist, mit echtem Interesse dabei und seine Zeit sinnvoll verbringt.',
      pull: 'Zeit für Sie. Erlebnisse, die für sie zählen.',
      image: '/images/home-not-to-be-rushed.webp',
      imageAlt: 'Eine kleine Gruppe Kinder erkundet gemeinsam, ohne Eile.',
    },
    gain: {
      eyebrow: 'Was Kinder mitnehmen',
      heading: 'Fähigkeiten lassen sich üben.',
      body: 'In echten Erlebnissen bekommen Kinder Gelegenheiten, zu erkunden, zu entscheiden, Probleme zu lösen, zusammenzuarbeiten, sich mitzuteilen, zu gestalten und zu entdecken, wozu sie fähig sind.',
      body2: 'Entwicklung kommt nicht aus einer einzelnen Aktivität. Erst wiederkehrende Erlebnisse geben Kindern die Gelegenheit, Fähigkeiten über die Zeit zu üben.',
    },
    different: {
      eyebrow: 'Was Narelo unterscheidet',
      heading: 'Nicht die Aktivitäten machen den Unterschied. Das Denken dahinter macht ihn.',
      body: 'Es kommt auf die Absicht hinter jedem Erlebnis an, darauf, wie die Pädagoginnen mit den Kindern umgehen, wie viel Anleitung sie geben, wie die Erlebnisse über die Zeit aufeinander aufbauen, und auf die Beständigkeit unserer Haltung.',
      notLabel: 'Wir fragen nicht einfach',
      notQuestion: 'Welche Aktivität machen wir?',
      askLabel: 'Wir fragen',
      askQuestion: 'Was soll das Kind erleben?',
    },
    approach: {
      eyebrow: 'Unser Ansatz',
      heading: 'Wir glauben an echtes Erleben, an menschliche Verbindung und an Anleitung mit Sinn.',
      body: 'Kinder bekommen Gelegenheiten, es zu versuchen, zu entscheiden, zu lösen, zusammenzuarbeiten und Herausforderungen zu erleben, begleitet von Pädagoginnen, denen sie vertrauen.',
      pull: 'Begleiten, ohne ihnen den Weg abzunehmen.',
    },
    worlds: {
    ...
    ways: {
      eyebrow: 'Wie Familien Narelo erleben können',
      items: [
        { name: 'Wöchentliche Erlebnisse der Mitgliedschaft', body: 'Regelmäßige Erlebnisse, die zählen, für die Kinder, und verlässliche Zeit für die Eltern.' },
        { name: 'Signature Saturdays', body: 'Zusätzliche Erlebnisse am Wochenende.' },
        { name: 'Holiday Experiences', body: 'Erlebnisse mit Sinn während der Schulferien.' },
        { name: 'Geburtstage', body: 'Narelo gestaltet und leitet das Erlebnis der Kinder.' },
        { name: 'Private Erlebnisse und Anlässe', body: 'Familien können Narelo für private Anlässe anfragen: die Kinder erleben etwas, das zählt, während die Eltern ihren eigenen Anlass genießen.' },
      ],
      linkLabel: 'Die Erlebnisse im Ganzen',
    ...
    ourBelief: {
      ...
      heading: 'Kinder brauchen mehr als Programm. Sie brauchen Erlebnisse, die zählen.',
      body: 'Wir glauben, dass Fähigkeiten sich üben lassen.',
      body2: 'Wir glauben, dass echtes Erleben, menschliche Verbindung, wiederkehrende Gelegenheiten und Anleitung mit Sinn Kindern guttun.',
      body3: 'Wir können nicht wissen, was die Zukunft von ihnen verlangen wird.',
      body4: 'Aber wir können ihnen Erlebnisse mitgeben, die sie auf das Leben vorbereiten.',
      pull: 'Eltern gewinnen Zeit. Kinder gewinnen Erlebnisse, die zählen.',
    },
    closing: {
  ...
  pages: {
    ...
    legalPage: {
      title: 'Impressum',
      intro: 'Wer hinter dieser Website steht, wie es das spanische Recht verlangt (Ley 34/2002 über Dienste der Informationsgesellschaft und den elektronischen Geschäftsverkehr).',
      rows: [
