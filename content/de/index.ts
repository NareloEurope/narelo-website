...
export const de: Dict = {
  ...
  home: {
    ...
    belief: {
      ...
      heading: 'Manches wird gelernt. Anderes muss gelebt werden.',
      body: 'Unsere Kinder wachsen in eine Welt hinein, die wir nicht vollständig vorhersehen können. Was wir ihnen geben können, sind Gelegenheiten, selbst zu denken, sich zu bewegen, zu gestalten, zu entscheiden, sich anzupassen und zu entdecken, wozu sie fähig sind.',
      pull: 'Genau da kommt Narelo ins Spiel.',
      image: '/images/home-moment-to-pause.webp',
      imageAlt: 'Ein Kind hält draußen inne und nimmt etwas in sich auf.',
    },
    parents: {
      eyebrow: 'Was das für Familien bedeutet',
      heading: 'Zeit für sie. Zeit für Sie.',
      body: 'Narelo schafft Erlebnisse, auf die Kinder sich freuen, und gibt Eltern zugleich verlässliche Zeit, auf die sie sich verlassen können.',
      body2: 'Von den wöchentlichen Erlebnissen über Samstage, Schulferien, Geburtstage, private Anlässe bis zu einzelnen privaten Erlebnissen: Familien können sich an Narelo wenden, wann immer die Zeit ihres Kindes mehr sein soll als einfach ausgefüllt.',
      pull: 'Sie gewinnen Zeit zurück. Ihre Kinder gewinnen Erlebnisse, die ihnen etwas zurückgeben.',
    ...
    different: {
      ...
      heading: 'Keine weitere Aktivität.',
      heading2: 'Ein breiterer Weg, auf dem Kinder wachsen.',
      body: 'Narelo ist nicht um ein Fach, eine Sportart oder eine Fertigkeit herum gebaut.',
      body2: 'Kinder bewegen sich, erkunden, bauen, gestalten, lösen Probleme, arbeiten zusammen und nehmen Herausforderungen an, in einer großen Bandbreite echter Erlebnisse.',
      body3: 'Hinter jedem Erlebnis steht eine Absicht: etwas Körperliches, Kreatives, Soziales oder Persönliches zu stärken.',
      body4: 'Und weil Kinder Woche für Woche wiederkommen, mit vertrauten Pädagoginnen und in einer kleinen Gruppe, bauen die Erlebnisse mit der Zeit aufeinander auf.',
      notLabel: 'Wir fragen nicht nur',
      notQuestion: 'Welche Aktivität machen wir?',
      askLabel: 'Wir fragen',
      askQuestion: 'Was kann dieses Erlebnis dem Kind geben?',
    },
    worlds: {
    ...
    closing: {
      ...
      body: 'Die Mitgliedschaft öffnet sich für eine kleine Zahl von Familien. Wenn Narelo nach etwas klingt, das Ihre Familie gesucht hat, lernen wir Sie gern kennen.',
      ctaLabel: 'Beginnen Sie ein Gespräch',
    },
  },
