...
export const hu: Dict = {
  ...
  home: {
    hero: {
      ...
      lede: 'A Narelo családoknak szóló privát klub, amely rendkívüli gyermekkori élmények köré épül.',
      lede2: 'A természeten, a kreativitáson, a mozgáson és a valódi kalandokon keresztül a gyerekek lehetőséget kapnak arra, hogy felfedezzenek, döntsenek, problémákat oldjanak meg, együttműködjenek, kapcsolatokat építsenek, és rájöjjenek, mire képesek.',
      video: '/video/home-hero.mp4',
      poster: '/images/home-hero-poster.webp',
      scrollHint: 'Görgess',
    },
    belief: {
      eyebrow: 'Miért a Narelo',
      heading: 'A gyerekeknek nem csak tudásra és programokra van szükségük. Valódi élményekre, amelyek számítanak.',
      body: 'A tudás és a tanulás fontos, de a gyerekeknek olyan valódi élményekre is szükségük van, amelyekben gyakorolhatják azokat a képességeket, amelyeket az élet majd kérni fog tőlük.',
      pull: 'Nem tudhatjuk pontosan, mit kér majd a jövő a gyerekeinktől. De adhatunk nekik olyan élményeket, amelyek felkészítik őket rá.',
    ...
    parents: {
      eyebrow: 'A szülőknek',
      heading: 'A ti időtök is számít.',
      body: 'A Narelo heti élményeivel a szülők rendszeres, nyugodt időt kapnak, miközben a gyerekeik szándékosan felépített élményekben vesznek részt.',
      body2: 'És amikor egy családnak ezen túl is segítségre van szüksége, szombaton, az iskolai szünetekben, születésnapkor, privát alkalmakon vagy egyedi privát élményeken, a Narelo ott is átveheti a gyerekek élményét.',
      body3: 'A szülők nyugodtan adhatják át a felelősséget, tudva, hogy a gyereküket szakemberek kísérik, valóban benne van, és jól tölti az idejét.',
      pull: 'Idő nektek. Élmények, amelyek nekik számítanak.',
      image: '/images/home-not-to-be-rushed.webp',
      imageAlt: 'Kisebb gyerekcsoport együtt fedez fel, sietség nélkül.',
    },
    gain: {
      eyebrow: 'Amit a gyerekek kapnak',
      heading: 'A képességek gyakorolhatók.',
      body: 'A valódi élményekben a gyerekek lehetőséget kapnak arra, hogy felfedezzenek, döntsenek, problémákat oldjanak meg, együttműködjenek, kifejezzék magukat, alkossanak, és rájöjjenek, mire képesek.',
      body2: 'A fejlődés nem egyetlen programból jön. Az ismétlődő élmények adnak alkalmat arra, hogy a gyerekek idővel gyakorolják ezeket a képességeket.',
    },
    different: {
      eyebrow: 'Mitől más a Narelo',
      heading: 'Nem a programok jelentik a különbséget. Hanem a mögöttük lévő gondolkodás.',
      body: 'Az számít, milyen szándék áll minden élmény mögött, hogyan viszonyulnak a pedagógusok a gyerekekhez, mennyi útmutatást kapnak, hogyan épülnek egymásra az élmények, és mennyire következetes a szemléletünk.',
      notLabel: 'Nem csak azt kérdezzük',
      notQuestion: 'Milyen programot csináljunk?',
      askLabel: 'Azt kérdezzük',
      askQuestion: 'Mit szeretnénk, hogy a gyerek megéljen?',
    },
    approach: {
      eyebrow: 'A megközelítésünk',
      heading: 'Hiszünk a valódi élményben, az emberi kapcsolatban és az értelmes kísérésben.',
      body: 'A gyerekek lehetőséget kapnak arra, hogy próbálkozzanak, döntsenek, megoldjanak, együttműködjenek és kihívásokat éljenek meg, olyan pedagógusok mellett, akikben megbíznak.',
      pull: 'Kísérés, anélkül hogy elvennénk tőlük az utat.',
    },
    worlds: {
      eyebrow: 'Az Öt Világ',
    ...
    ways: {
      eyebrow: 'Hogyan élheti meg egy család a Narelót',
      items: [
        { name: 'Heti tagsági élmények', body: 'Rendszeres, valódi élmények a gyerekeknek, és nyugodt idő a szülőknek.' },
        { name: 'Signature Saturdays', body: 'További élmények a hétvégén.' },
        { name: 'Holiday Experiences', body: 'Tartalmas élmények az iskolai szünetekben.' },
        { name: 'Születésnapok', body: 'A Narelo alkotja meg és vezeti a gyerekek élményét.' },
        { name: 'Privát élmények és rendezvények', body: 'A családok privát alkalmakra is kérhetik a Narelót: a gyerekek valódi élményt kapnak, miközben a szülők a saját eseményüket élvezhetik.' },
      ],
      linkLabel: 'Az élmények részletesen',
    ...
    ourBelief: {
      ...
      heading: 'A gyerekeknek nem csak programokra van szükségük. Olyan élményekre, amelyek számítanak.',
      body: 'Hisszük, hogy a képességek gyakorolhatók.',
      body2: 'Hisszük, hogy a gyerekeknek jót tesznek a valódi élmények, az emberi kapcsolat, az ismétlődő alkalmak és az értelmes kísérés.',
      body3: 'Nem tudhatjuk pontosan, mit fog kérni tőlük a jövő.',
      body4: 'De adhatunk nekik olyan élményeket, amelyek felkészítik őket az életre.',
      pull: 'A szülők időt nyernek. A gyerekek élményt, ami számít.',
    },
    closing: {
