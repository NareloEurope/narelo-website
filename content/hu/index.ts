...
export const hu: Dict = {
  ...
  home: {
    ...
    belief: {
      ...
      heading: 'Van, amit megtanulunk. És van, amit meg kell élni.',
      body: 'A gyerekeink egy olyan világba nőnek bele, amelyet nem tudunk teljesen előre látni. Amit adhatunk nekik, az a lehetőség, hogy önállóan gondolkodjanak, mozogjanak, alkossanak, döntsenek, alkalmazkodjanak, és rájöjjenek, mire képesek.',
      pull: 'Itt lép be a Narelo.',
      image: '/images/home-moment-to-pause.webp',
      imageAlt: 'Egy gyerek megáll a szabadban, és befogadja, ami körülötte van.',
    },
    parents: {
      eyebrow: 'Mit jelent ez a családoknak',
      heading: 'Idő nekik. Idő neked.',
      body: 'A Narelo olyan élményeket hoz létre, amelyeket a gyerekek várnak, és közben a szülőknek is ad egy nyugodt időt, amelyre számíthatnak.',
      body2: 'A heti élményektől a szombatokon, az iskolai szüneteken, a születésnapokon, a privát rendezvényeken át az egyedi privát élményekig: a családok bármikor fordulhatnak a Narelóhoz, amikor azt szeretnék, hogy a gyerekük ideje több legyen puszta időtöltésnél.',
      pull: 'Te időt kapsz vissza. Ők élményeket, amelyek adnak nekik valamit.',
    ...
    different: {
      ...
      heading: 'Nem egy újabb program.',
      heading2: 'Egy tágabb út, amelyen a gyerekek nőhetnek.',
      body: 'A Narelo nem egyetlen tantárgy, sport vagy készség köré épül.',
      body2: 'A gyerekek mozognak, felfedeznek, építenek, alkotnak, problémákat oldanak meg, együttműködnek és kihívásokat vállalnak, sokféle valódi élményen keresztül.',
      body3: 'Minden élmény mögött ott a szándék: erősíteni valamit, ami testi, alkotó, közösségi vagy személyes.',
      body4: 'És mivel a gyerekek hétről hétre visszatérnek, ismerős pedagógusokkal és kis csoportban, az élmények idővel egymásra épülnek.',
      notLabel: 'Nem csak azt kérdezzük',
      notQuestion: 'Milyen programot csináljunk?',
      askLabel: 'Azt kérdezzük',
      askQuestion: 'Mit adhat ez az élmény a gyereknek?',
    },
    worlds: {
      eyebrow: 'Az Öt Világ',
    ...
    closing: {
      ...
      body: 'A tagság kisszámú család előtt nyílik meg. Ha úgy érzed, a Narelo az, amit a családotok keresett, szívesen megismernénk titeket.',
      ctaLabel: 'Kezdjünk egy beszélgetést',
    },
  },
