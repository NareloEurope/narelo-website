...
import { hero, testimonials, gallery, belong, events, journalTeaser } from '@/content/community';

export const metadata = {
  title: 'Community',
  description: belong.body,
  openGraph: { title: 'Community | Narelo', description: belong.body, images: ['/images/community-hero.webp'] },
};
